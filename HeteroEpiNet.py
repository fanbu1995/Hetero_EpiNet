...
class HeteroEpiNet:
    ...
    def simulate(self, T=100, p0 = None, G0 = None, I0 = None, params=None, initInfec=1, seed = 42, verbose=True):
        ...
        # initial infections
        # (set initial infections as EXPOSED)
...
#                print(rows)          
    ...
    # UPDATED: 09/20/2020
    # simulation function
    def simulateNew(self, T=100, p0 = None, G0 = None, I0 = None, params=None, 
                    initInfec=1, seed = 42, verbose=True):
        '''
        T: maximum simulation length
        p0: initial network density for Erdos-Renyi graph
        G0: initial network adjacency matrix, as given (will)
...
res = EpiNet.simulate(T=50, p0=0.2, params=pa, verbose=True)          
